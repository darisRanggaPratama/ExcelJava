...
class DecCells {
    companion object {
        private val logger = getLogger("DecCells")
        fun checkDecimal() {
            // COLOR
            val BLUE = "\u001B[34m"
            val RESET = "\u001B[0m"
            ...
            try {
                ...
                val newSheet = workbook.createSheet("DEC")
                ...
                for (rowIdx in Data.beginRow..Data.endRow) {
                    ...
                    for (colIdx in Data.firstColumn..Data.lastColumn) {
                        ...
                        if (cell != null && cell.cellType == CellType.NUMERIC) {
                            ...
                            val intValue = cellValue.toInt()
                            if (cellValue != intValue.toDouble()) {
                                ...
                                comment.string = XSSFRichTextString("Decimal: $cellValue")
